...
Combined with the getusermedia API \cite{getusermedia}, streams can be
shown or recorded also from a local media source, such as a web
camera. These specifications have lots of security and privacy issues
to handle, but they promise very strong multimedia capabilities for
web applications.
...
\subsubsection{Analytics and Timing}
...
\subsubsection{Page Visibility and Timer Control}
