...
\begin{itemize}
\item simple REST backend as a dummy data layer
\item all functionality in the client side
\item application state in the frontend
\item data persistency in the backend, frontend, or both
\end{itemize}

\subsubsection{JavaScript MVC Libraries}

\begin{itemize}
\item define MVC/MVVM etc. application patterns
\item introduce example MVC libraries like backbone.js
\end{itemize}
