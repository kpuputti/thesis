...
\begin{itemize}
\item \textbf{RQ1}: What are the main problem areas in mobile web
  development?
\item \textbf{RQ2}: Do HTML5 and related specifications solve these
  problems?
\item \textbf{RQ3}: What other practical means do we have to solve
  these problems?
\end{itemize}
